...
################################################################
# This is a generated script based on design: Atelier2_bd
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins myColorRegister_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_net -net Net1 [get_bd_pins myColorRegister_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins testPatternGenerator_0/rstn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_proc_ss_0/aresetn_ctrl] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins myColorRegister_0/s00_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins testPatternGenerator_0/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_proc_ss_0/aclk_axis] [get_bd_pins v_proc_ss_0/aclk_ctrl] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net myColorRegister_0_o_imageDataA [get_bd_pins myColorRegister_0/o_imageDataA] [get_bd_pins testPatternGenerator_0/i_colorDataA]
  connect_bd_net -net myColorRegister_0_o_imageDataB [get_bd_pins myColorRegister_0/o_imageDataB] [get_bd_pins testPatternGenerator_0/i_colorDataB]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net reset_rtl_1 [get_bd_ports reset_rtl] [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myColorRegister_0/S00_AXI/S00_AXI_reg] -force
