...
module bd_c800_hsc_0_v_vcresampler_core (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
bd_c800_hsc_0_v_vcresampler_core_linebuf_y_val_V_0 #(
    .DataWidth( 8 ),
    .AddressRange( 1280 ),
    .AddressWidth( 11 ))
linebuf_y_val_V_0_U(
...
bd_c800_hsc_0_v_vcresampler_core_linebuf_c_val_V_0 #(
    .DataWidth( 8 ),
    .AddressRange( 1280 ),
    .AddressWidth( 11 ))
linebuf_c_val_V_0_U(
...
endmodule //bd_c800_hsc_0_v_vcresampler_core
