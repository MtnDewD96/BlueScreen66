...
#
# Generated by export_simulation on Thu Feb 10 11:51:36 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './Atelier2_bd.sh' script.

./Atelier2_bd.sh -reset_run
...
./Atelier2_bd.sh -noclean_files

For more information on the script, please type './Atelier2_bd.sh -help'.
